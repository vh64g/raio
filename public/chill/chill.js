...
function newPlayerColor() {
    let a_colors = [];
    circles.forEach(circle => {a_colors.push(circle.color);});
    if (a_colors.length === 0) {a_colors = colors;}
    player_color = a_colors[getRandom(0, a_colors.length-1)];
